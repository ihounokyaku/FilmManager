...
extension NSImage {
    ...
    static func SafeImage(fromData data:Data?)->NSImage {
        
        let safeImage = NSImage(named: "noImage")!
        
        guard let realData = data else {return safeImage}
        
        return NSImage(data: realData) ?? safeImage
    ...
    func resizeCanvas(size: NSSize) -> NSImage? {
